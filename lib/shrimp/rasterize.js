  ...
  if (system.args.length > 3 && system.args[2].substr(-4) === ".pdf") {
    ...
    if(size.length === 2) {
      ...
      page_options.paperSize = {
        ...
        header: {
          height: "1cm",
          contents: phantom.callback(function(pageNum, numPages) { return header })
        },
        footer: {
          height: "1cm",
          contents: phantom.callback(function(pageNum, numPages) { return footer })
        }
      };
    }
  }
